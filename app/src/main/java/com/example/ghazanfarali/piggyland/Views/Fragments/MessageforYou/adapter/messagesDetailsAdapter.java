 ...
 */
public class messagesDetailsAdapter extends RecyclerView.Adapter<messagesDetailsAdapter.ViewHolder>{
    ...
    public messagesDetailsAdapter(MasterFragment dockActivity, ArrayList<mygallarylist> sections) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        final View sView = mInflater.inflate(R.layout.messageslistdetailsitem, parent, false);
