 ...
 */
public class messageForYouAdapter extends RecyclerView.Adapter<messageForYouAdapter.ViewHolder>{
    ...
    public messageForYouAdapter(MasterFragment dockActivity, ArrayList<mygallarylist> sections) {
