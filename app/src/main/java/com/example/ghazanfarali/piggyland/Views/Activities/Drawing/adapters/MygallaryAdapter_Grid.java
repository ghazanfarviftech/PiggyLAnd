 ...
 */
public class MygallaryAdapter_Grid extends RecyclerView.Adapter<MygallaryAdapter_Grid.ViewHolder>{
    ...
    public MygallaryAdapter_Grid(Activity dockActivity, ArrayList<mygallarylist> sections) {
